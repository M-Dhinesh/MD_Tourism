...
namespace TravelAgents
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IRepo<TravelAgentUser, int>, UserRepo>();
            builder.Services.AddScoped<IRepo<TravelAgentFeedback, int>, FeedbackRepo>();
            builder.Services.AddScoped<IServices, TravelAgentServices>();
